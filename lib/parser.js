module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c36 = function(loop) {
                return loop;
            },
        peg$c37 = function(k, v, exp, chunks) {
        ...
        peg$c56 = function(val) { return parseInt(val, 10); },
        peg$c57 = "0",
        peg$c58 = { type: "literal", value: "0", description: "\"0\"" },
        peg$c59 = function() { return 0; },
        peg$c60 = "$",
        peg$c61 = { type: "literal", value: "$", description: "\"$\"" },
        peg$c62 = function(m) {
                return mkMemberAccess('defaults', m);
            },
        peg$c63 = function(v, m) {
        ...
        peg$c80 = function() { return String.fromCharCode(123); /* workaround for pegjs bug */ },
        peg$c81 = /^[^{"]/,
        peg$c82 = { type: "class", value: "[^{\"]", description: "[^{\"]" },
        peg$c83 = function(sym) {
        ...
        peg$c90 = function(items) {
                return mk(T.ARRAY_LITERAL, {items: items || []});
            },
        peg$c91 = "}",
        peg$c92 = { type: "literal", value: "}", description: "\"}\"" },
        peg$c93 = function(items) {
        ...
        peg$c113 = /^[a-z]/i,
        peg$c114 = { type: "class", value: "[a-z]i", description: "[a-z]i" },
        peg$c115 = /^[a-z0-9_\-]/i,
        peg$c116 = { type: "class", value: "[a-z0-9_\\-]i", description: "[a-z0-9_\\-]i" },
        peg$c117 = function(name) { return name; },
        peg$c118 = /^[a-zA-Z_]/i,
        peg$c119 = { type: "class", value: "[a-zA-Z_]i", description: "[a-zA-Z_]i" },
        peg$c120 = /^[a-zA-Z0-9_]/,
        ...
        peg$c129 = "then",
        peg$c130 = { type: "literal", value: "then", description: "\"then\"" },
        peg$c131 = "else",
        peg$c132 = { type: "literal", value: "else", description: "\"else\"" },
        peg$c133 = "end",
        peg$c134 = { type: "literal", value: "end", description: "\"end\"" },
        peg$c135 = "foreach",
        peg$c136 = { type: "literal", value: "foreach", description: "\"foreach\"" },
    ...
    function peg$parseTemplateLoop() {
      var s0, s1, s2;

      s0 = peg$currPos;
      s1 = peg$parseTemplateForeach();
      if (s1 !== peg$FAILED) {
        s2 = peg$parseTemplateEnd();
        if (s2 !== peg$FAILED) {
          peg$reportedPos = s0;
          s1 = peg$c36(s1);
          s0 = s1;
    ...
    function peg$parseTemplateForeach() {
            ...
            if (s4 !== peg$FAILED) {
              ...
              if (s5 !== peg$FAILED) {
                ...
                if (s6 !== peg$FAILED) {
                  s7 = peg$parse_();
                  if (s7 !== peg$FAILED) {
                    s8 = peg$parseInKeyword();
                    if (s8 !== peg$FAILED) {
                      s9 = peg$parse_();
                      if (s9 !== peg$FAILED) {
                        s10 = peg$parseScriptExpression();
                        if (s10 !== peg$FAILED) {
                          s11 = peg$parse_();
                          if (s11 !== peg$FAILED) {
                            if (input.substr(peg$currPos, 2) === peg$c32) {
                            ...
                            if (s12 !== peg$FAILED) {
                              s13 = peg$parseFileTemplate();
                              if (s13 !== peg$FAILED) {
                                peg$reportedPos = s0;
                                s1 = peg$c37(s5, s6, s10, s13);
                                s0 = s1;
                              } else {
                                peg$currPos = s0;
                                s0 = peg$c0;
    ...
    function peg$parseForeachKeyword() {
      var s0, s1, s2, s3;
